...
function ia(){function a(b,c){if(b instanceof Y){var d=b.s.elements,d=" matrix(1,0,0,1,"+d[12]+","+d[13]+")",f=b.element,g=e[b.id];if(void 0===g||g!==d)f.style.WebkitTransform=d,f.style.MozTransform=d,f.style.Ja=d,f.style.transform=d,e[b.id]=d;f.parentNode!==h&&h.appendChild(f)}d=0;for(f=b.children.length;d<f;d++)a(b.children[d],c)}var b,c=!0,d=0,f="",e={},g=1,k=document.createElement("div");k.style.overflow="hidden";this.a=k;var h=document.createElement("div");k.appendChild(h);this.Oa=function(a){c=
a};this.ra=function(a,c){b=c;k.style.width=a+"px";k.style.height=c+"px";h.style.width=a+"px";h.style.height=c+"px"};this.j=function(e,g){var l=.5/Math.tan(H(.5*g.l))*b;d!==l&&(d=l);K(e);void 0===g.parent&&K(g);ca(g.Ga,g.s);l=" scale("+this.Ca(g,k)+") translate("+-g.position.x+"px,"+g.position.y+"px)"+(c?" translate3d(0,0,0)":"");f!==l&&(h.style.WebkitTransform=l,h.style.MozTransform=l,h.style.Ja=l,f=h.style.transform=l);a(e,g)};this.Ca=function(a,b){var c=g;if(0!==b.clientHeight||"undefined"===typeof g)g=
c=.5/Math.tan(H(.5*a.l))*b.clientHeight;return c/a.position.z}};function ja(a,b){function c(a){if(!1!==e.enabled){a.preventDefault();if(x===q.ga){if(!0===e.C)return;p.set(a.clientX,a.clientY);t.G(p,l);0<t.y?e.W():e.X();l.g(p)}else if(x===q.ha){if(!0===e.B)return;k.set(a.clientX,a.clientY);h.G(k,g);e.pan(h.x,h.y);g.g(k)}e.update()}}function d(a){if(!1!==e.enabled){if(2==a.button&&"undefined"!==e.ea&&130>new Date-e.ea.time){a=e.ea.Ka;var b=new CustomEvent("mz_contextmenu");b.clientX=a.clientX;b.clientY=a.clientY;b.target=a.target;a.target.dispatchEvent(b)}document.removeEventListener("mousemove",
...
function ma(a,b,c){b=b.children;for(var d=0;d<b.length;d++)c.call(a,b[d])}function ka(a){a.controls=new ja(a.J,a.o.a);a.controls.H=a.options.H;a.controls.P=a.options.P;a.controls.O=a.options.O;a.controls.U=a.options.U;a.controls.D=a.options.D;!0===a.options.ma&&(a.controls.a.addEventListener("contextmenu",function(a){a.preventDefault()},!1),a.i.addEventListener("contextmenu",function(a){a.preventDefault()},!1));a.controls.addEventListener("change",a.j);a.j()}
y.j=function(){this.o.j(this.v,this.J);var a=new CustomEvent("mz_render");a.mz_scale=this.controls.K;a.mz_center_x=this.controls.object.position.x;a.mz_center_y=this.controls.object.position.y;this.dispatchEvent(a)};y.ka=function(a,b){var c=new Y(a);c.position.x=b.left;c.position.y=b.top;c.position.z=0;this.v.add(c)};y.ya=function(a,b){this.ka(a,b);this.j()};
y.Ma=function(a){for(var b=null,c=0;c<this.v.children.length;c++)this.v.children[c].element===a&&(b=this.v.children[c]);null!==b?this.v.remove(b):console.warn("The specified element could not be removed from the makeItZoom workspace, because it couldn't be found.");this.j()};y.pa=function(a){for(var b=0,c=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)b+=a.offsetLeft-a.scrollLeft,c+=a.offsetTop-a.scrollTop,a=a.offsetParent;return{top:c,left:b}};y.Ba=function(){return this.controls.K};
