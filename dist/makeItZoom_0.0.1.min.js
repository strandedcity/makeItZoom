...
function P(a,b){if(!0===a.ea){var c=a.B,d=a.position,f=a.scale,g=a.ha,h=c.elements,n=g.x,p=g.y,q=g.z,e=g.ka,l=n+n,m=p+p,k=q+q,g=n*l,t=n*m,n=n*k,r=p*m,p=p*k,q=q*k,l=e*l,m=e*m,e=e*k;h[0]=1-(r+q);h[4]=t-e;h[8]=n+m;h[1]=t+e;h[5]=1-(g+q);h[9]=p-l;h[2]=n-m;h[6]=p+l;h[10]=1-(g+r);h[3]=0;h[7]=0;h[11]=0;h[12]=0;h[13]=0;h[14]=0;h[15]=1;c.scale(f);c.setPosition(d);a.fa=!0}if(!0===a.fa||!0===b)void 0===a.parent?a.C.a(a.B):ba(a.C,a.parent.C,a.B),a.fa=!1,b=!0;c=0;for(d=a.children.length;c<d;c++)P(a.children[c],
b)}J.prototype.apply(L.prototype);var ga=0;function Q(){L.call(this);this.type="Camera";this.Sa=new F;this.I=new F}Q.prototype=Object.create(L.prototype);Q.prototype.constructor=Q;function R(a,b,c,d){Q.call(this);this.type="PerspectiveCamera";this.zoom=1;this.j=void 0!==a?a:50;this.L=void 0!==b?b:1;this.D=void 0!==c?c:.1;this.O=void 0!==d?d:2E3;ha(this)}R.prototype=Object.create(Q.prototype);R.prototype.constructor=R;
function ha(a){var b=fa(2*Math.atan(Math.tan(.5*K(a.j))/a.zoom));if(a.da){var c=a.da/a.ta,d=Math.tan(K(.5*b))*a.D,b=-d,f=c*b,c=Math.abs(c*d-f),b=Math.abs(d-b);da(a.I,f+a.x*c/a.da,f+(a.x+a.width)*c/a.da,d-(a.y+a.height)*b/a.ta,d-a.y*b/a.ta,a.D,a.O)}else{d=a.I;f=a.L;c=a.D;a=a.O;var b=c*Math.tan(K(.5*b)),g=-b;da(d,g*f,b*f,g,b,c,a)}}R.prototype.clone=function(){var a=new R;Q.prototype.clone.call(this,a);a.zoom=this.zoom;a.j=this.j;a.L=this.L;a.D=this.D;a.O=this.O;a.I.a(this.I);return a};function X(){L.call(this);this.type="Scene";this.ga=this.ca=null;this.qa=!0}X.prototype=Object.create(L.prototype);X.prototype.constructor=X;X.prototype.clone=function(a){void 0===a&&(a=new X);L.prototype.clone.call(this,a);null!==this.ca&&(a.ca=this.ca.clone());null!==this.ga&&(a.ga=this.ga.clone());a.qa=this.qa;a.ea=this.ea;return a};function Y(a){L.call(this);this.element=a;this.element.style.position="absolute";this.addEventListener("removed",function(){null!==this.element.parentNode&&this.element.parentNode.removeChild(this.element)})}Y.prototype=Object.create(L.prototype);
function ia(a){function b(a,c){if(a instanceof Y){var d=a.element,f=e[a.id];if(void 0===f||""!==f)d.style.WebkitTransform="",d.style.MozTransform="",d.style.Ua="",d.style.transform="",e[a.id]="";d.parentNode!==k&&k.appendChild(d)}d=0;for(f=a.children.length;d<f;d++)b(a.children[d],c)}var c=1,d,f,g,h,n=!0,p=0,q="",e={},l=1,m=document.createElement("div");a&&(m=a);m.style.overflow="hidden";this.b=m;var k=document.createElement("div");m.appendChild(k);this.cb=function(a){n=a};this.Za=function(a){c=1;
"CENTER"===a&&(c=0)};this.xa=function(a,b){d=a;f=b;g=d/2;h=f/2;m.style.width=a+"px";m.style.height=b+"px";k.style.width=a+"px";k.style.height=b+"px"};this.m=function(a,d){var e=.5/Math.tan(K(.5*d.j))*f;p!==e&&(p=e);P(a);void 0===d.parent&&P(d);ca(d.Sa,d.C);var e=-d.position.x,l=d.position.y;1===c&&(e+=g,l+=h);e=" scale("+this.Pa(d,m)+") translate("+e+"px,"+l+"px)"+(n?" translate3d(0,0,0)":"");q!==e&&(k.style.WebkitTransform=e,k.style.MozTransform=e,k.style.Ua=e,q=k.style.transform=e);b(a,d)};this.Pa=
function(a,b){var c=l;if(0!==b.clientHeight||"undefined"===typeof l)l=c=.5/Math.tan(K(.5*a.j))*b.clientHeight;return c/a.position.z}};function ja(a,b){function c(a){if(!1!==e.enabled){if(1===a.button){if(!0===e.G)return;a.preventDefault();A=y.la;u.set(a.clientX,a.clientY)}else if(a.button===e.H){if(!0===e.F)return;a.preventDefault();A=y.ma;l.set(a.clientX,a.clientY);e.ja={time:new Date,Va:a}}document.addEventListener("mousemove",d,!1);document.addEventListener("mouseup",f,!1);e.dispatchEvent(H)}}function d(a){if(!1!==e.enabled){a.preventDefault();if(A===y.la){if(!0===e.G)return;v.set(a.clientX,a.clientY);w.J(v,u);0<w.y?e.$():e.aa();
u.a(v)}else if(A===y.ma){if(!0===e.F)return;m.set(a.clientX,a.clientY);k.J(m,l);e.pan(k.x,k.y);l.a(m)}e.update()}}function f(a){if(!1!==e.enabled){if(2==a.button&&"undefined"!==e.ja&&130>new Date-e.ja.time){a=e.ja.Va;var b=new CustomEvent("mz_contextmenu");b.clientX=a.clientX;b.clientY=a.clientY;b.target=a.target;a.target.dispatchEvent(b)}document.removeEventListener("mousemove",d,!1);document.removeEventListener("mouseup",f,!1);e.dispatchEvent(I);A=y.NONE}}function g(a){!0===e.X&&(e.clientX=a.clientX,
e.clientY=a.clientY,e.ia=!0);if(!1!==e.enabled&&!0!==e.G){var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);0<b?e.aa():e.$();e.update();e.dispatchEvent(H);e.dispatchEvent(I)}}function h(a){if(!1!==e.enabled&&!0!==e.Ta&&!0!==e.F)switch(a.keyCode){case e.keys.Ea:e.pan(0,e.P);e.update();break;case e.keys.Aa:e.pan(0,-e.P);e.update();break;case e.keys.Ba:e.pan(e.P,0);e.update();break;case e.keys.Ca:e.pan(-e.P,0),e.update()}}function n(a){if(!1!==e.enabled){switch(a.touches.length){case 1:return;
...
v.set(0,Math.sqrt(b*b+a*a));w.J(v,u);0<w.y?e.aa():e.$();u.a(v);e.update();break;case 3:if(!0===e.F)break;if(A!==y.oa)break;m.set(a.touches[0].pageX,a.touches[0].pageY);k.J(m,l);e.pan(k.x,k.y);l.a(m);e.update();break;default:A=y.NONE}}function q(){!1!==e.enabled&&(e.dispatchEvent(I),A=y.NONE)}this.object=a;this.b=void 0!==b?b:document;this.Y=this.enabled=!0;this.target=new E;this.G=!1;this.K=1;this.X=!0;this.S=.05;this.M=this.R=1;this.i=null;this.H=2;this.F=!1;this.P=7;this.Ta=!1;this.keys={Ba:37,
Ea:38,Ca:39,Aa:40};var e=this,l=new C,m=new C,k=new C,t=new E,r=new E,u=new C,v=new C,w=new C,D=1,x=new E,M=new E,N=new G,y={NONE:-1,la:1,ma:2,na:4,oa:5},A=y.NONE;this.gb=this.target.clone();this.Wa=this.object.position.clone();(new G).bb(a.hb,new E(0,1,0));var O={type:"change"},H={type:"start"},I={type:"end"};this.wa=function(a){D=.5/Math.tan(K(.5*this.object.j))*this.b.clientHeight/a/this.object.position.z};this.eb=function(a){this.R=a};this.va=function(a){this.S=null===this.i?a:this.Ja(this.i)};
this.Ja=function(a){return Math.min(this.b.clientWidth/(a.right-a.left),this.b.clientHeight/(a.bottom-a.top))};this.ib=function(a){if(null==a||"object"!=typeof a)return null;for(var b=["top","left","bottom","right"],c=[-1,-1,1,1],d=!1,e={},f=0;f<b.length;f++)"[object Number]"===toString.call(a[b[f]])&&(d=!0),e[b[f]]="[object Number]"===toString.call(a[b[f]])?a[b[f]]:Infinity*c[f];return d?e:(B("Invalid bounds object specified."),null)};this.$a=function(a){this.i=a=this.ib(a);null!==a&&this.va(1)};
this.U=function(a){var b=this.object.B.elements;t.set(b[0],b[1],b[2]);t.w(-a);x.add(t)};this.V=function(a){var b=this.object.B.elements;t.set(b[4],b[5],b[6]);t.w(a);x.add(t)};this.pan=function(a,b){var c=e.b===document?e.b.body:e.b;if(void 0!==e.object.j){var d=e.object.position.clone().sub(e.target).length(),d=d*Math.tan(e.object.j/2*Math.PI/180);e.U(2*a*d/c.clientHeight);e.V(2*b*d/c.clientHeight)}else void 0!==e.object.top?(e.U(a*(e.object.right-e.object.left)/c.clientWidth),e.V(b*(e.object.top-
e.object.bottom)/c.clientHeight)):console.warn("WARNING: ZoomControls.js encountered an unknown camera type - pan disabled.")};this.$=function(){var a;void 0===a&&(a=Math.pow(.95,e.K));D/=a};this.aa=function(){var a;void 0===a&&(a=Math.pow(.95,e.K));D*=a};this.W=function(a){var b=new E;b.set(e.clientX/e.b.clientWidth*2-1,2*-(e.clientY/e.b.clientHeight)+1,.5);b.W(a);var b=b.sub(a.position).normalize(),c=-a.position.z/b.z;return a.position.clone().add(b.w(c))};this.update=function(a,b){var c=!1,d;e.ia&&
...
x.y>-e.i.top&&(g+=-p-e.i.top+k-f.y-x.y);-n+l+f.x+x.x<e.i.left&&(d+=n+e.i.left-l-f.x-x.x);+p-f.y-x.y+k>e.i.bottom&&(m+=+p-e.i.bottom+k-f.y-x.y);n+f.x+x.x+l>e.i.right&&(h+=-n+e.i.right-l-f.x-x.x);.001>Math.abs(d)&&(d=0);.001>Math.abs(h)&&(h=0);.001>Math.abs(m)&&(m=0);.001>Math.abs(g)&&(g=0);if(0!==d||0!==g||0!==h||0!==m)c=!0,k=g+m,l=d+h,0!==g&&0!==m&&(k/=2,x.za(0)),0!==d&&0!==h&&(l/=2,x.ya(0)),x.set(l+x.x,k+x.y,0)}c&&(this.target.add(x),f.a(this.target).add(r),x.set(0,0,0),D=1);if(1E-6<M.sa(this.object.position)||
1E-6<8*(1-N.N(this.object.ha)))this.dispatchEvent(O),M.a(this.object.position),N.a(this.object.ha)};this.reset=function(){A=y.NONE;this.target.a(this.gb);this.object.position.a(this.Wa);this.update()};this.ba=function(a){var b=this.b;a=!1!==a;var b={mousedown:{element:b,s:c},mousewheel:{element:b,s:g},DOMMouseScroll:{element:b,s:g},touchstart:{element:b,s:n},touchend:{element:b,s:q},touchmove:{element:b,s:p},keydown:{element:window,s:h}},d=!1!==a?"addEventListener":"removeEventListener";if(this.Y!==
a||!0!==this.Fa){this.Fa=!0;this.Y=a;for(var e in b)b.hasOwnProperty(e)&&b[e].element[d].apply(b[e].element,[e,b[e].s,!1])}}.bind(this);this.ba(this.Y);this.update()}ja.prototype=Object.create(J.prototype);function Z(a){var b=a||{};a={};a.Ka=b.containerId||"makeItZoom";a.R=b.maxZoomScale||1;a.S=b.minZoomScale||.1;a.K=b.zoomSpeed||2;a.X=!1!==b.zoomTowardMouse;a.H="undefined"!=typeof b.panButton?b.H:2;a.ra="boolean"===typeof b.disableNativeContextMenu?b.ra:!0;a.Qa=!1!==b.hardwareAccelerated;a.fullScreen=!0===b.fullScreen;a.i=b.bounds||null;a.jb=!0!==b.zeroAtCenter;a.La=!1!==b.enableUserInteractions;this.options=a;this.l=document.getElementById(a.Ka);b=this.Ia.call(this,this.l);this.width=this.l.offsetWidth;
this.height=this.l.offsetHeight;this.v=new R(70,this.width/this.height,1,1E6);this.A=new X;this.Ya.call(this,b);this.u=new ia(this.l);this.u.Za(this.options.jb?"CENTER":"TOP_LEFT");this.u.xa(this.width,this.height);this.u.cb(a.Qa);this.u.b.style.position="absolute";this.m=this.m.bind(this);ka(this);this.controls.wa(1);la(this,a.fullScreen);this.controls.update()}z=Z.prototype;z.ab=function(a){this.controls.ba(a)};
function la(a,b){function c(){d.l.style.width=window.innerWidth;d.l.style.height=window.innerHeight;d.width=d.l.offsetWidth;d.height=d.l.offsetHeight;d.v.L=window.innerWidth/window.innerHeight;ha(d.v);d.u.xa(window.innerWidth,window.innerHeight);d.m()}var d=a;!0===b?(c(),window.addEventListener("resize",c,!1)):window.removeEventListener("resize",c,!1)}z.Na=function(){return this.l};
z.Ia=function(a){var b=this,c=[];ma(this,a,function(a){var d=b.ua(a),f=getComputedStyle(a).getPropertyValue("position");if("relative"===f||"static"===f)a.T=d;c.push(a)});for(var d=0;d<c.length;d++){var f=c[d];a.removeChild(f);f.T&&(f.style.position="absolute",f.style.top=f.T.top+"px",f.style.left=f.T.left+"px")}return c};z.Ya=function(a){for(var b=0;b<a.length;b++){var c=a[b];this.pa.call(this,c,c.T)}};
z.pa=function(a,b){var c=new Y(a);b&&(c.element.style.left=b.left+"px",c.element.style.top=b.top+"px");c.position.z=0;this.A.add(c)};function ma(a,b,c){b=b.children;for(var d=0;d<b.length;d++)c.call(a,b[d])}
function ka(a){a.controls=new ja(a.v,a.u.b);a.controls.K=a.options.K;a.controls.va(a.options.S);a.controls.eb(a.options.R);a.controls.$a(a.options.i);a.controls.ba(a.options.La);a.controls.X=a.options.X;a.controls.H=a.options.H;!0===a.options.ra&&a.controls.b.addEventListener("contextmenu",function(a){a.preventDefault()},!1);a.controls.addEventListener("change",a.m);a.m()}
z.m=function(){this.u.m(this.A,this.v);var a={type:"mz_render"};a.mz_scale=this.controls.M;a.mz_center_x=this.controls.object.position.x;a.mz_center_y=this.controls.object.position.y;this.dispatchEvent(a)};z.Ha=function(a,b){this.pa(a,{left:b.left,top:b.top});this.m()};
z.Xa=function(a){for(var b=null,c=0;c<this.A.children.length;c++)this.A.children[c].element===a&&(b=this.A.children[c]);null!==b?this.A.remove(b):console.warn("The specified element could not be removed from the makeItZoom workspace, because it couldn't be found.");this.m()};z.ua=function(a){for(var b=0,c=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)b+=a.offsetLeft-a.scrollLeft,c+=a.offsetTop-a.scrollTop,a=a.offsetParent;return{top:c,left:b}};z.Oa=function(){return this.controls.M};
z.Ma=function(){return{x:this.v.position.x,y:this.v.position.y}};z.kb=function(a,b,c){var d=this.controls.object.position.x,f=this.controls.object.position.y,g=this.controls.M;"number"!==typeof a&&(a=d);"number"!==typeof b&&(b=f);"number"!==typeof c&&(c=g);this.controls.U(d-a);this.controls.V(-b-f);this.controls.wa(c);this.controls.update(!0)};J.prototype.apply(Z.prototype);window.makeItZoom=Z;Z.prototype.addZoomable=Z.prototype.Ha;Z.prototype.removeZoomable=Z.prototype.Xa;Z.prototype.zoomTo=Z.prototype.kb;
