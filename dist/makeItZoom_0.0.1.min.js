...
this.x-a.x,c=this.y-a.y;a=this.z-a.z;return b*b+c*c+a*a},clone:function(){return new B(this.x,this.y,this.z)}};function F(a,b,c,d){this.b=a||0;this.c=b||0;this.f=c||0;this.h=void 0!==d?d:1}
F.prototype={constructor:F,b:0,c:0,f:0,h:0,get x(){return this.b},set x(a){this.b=a},get y(){return this.c},set y(a){this.c=a},get z(){return this.f},set z(a){this.f=a},get fa(){return this.h},set fa(a){this.h=a},set:function(a,b,c,d){this.b=a;this.c=b;this.f=c;this.h=d;return this},g:function(a){this.b=a.x;this.c=a.y;this.f=a.z;this.h=a.fa;return this},Ma:function(){var a,b;return function(c,d){void 0===a&&(a=new B);b=c.L(d)+1;if(1E-6>b)b=0,Math.abs(c.x)>Math.abs(c.z)?a.set(-c.y,c.x,0):a.set(0,-c.z,
...
function ba(a,b,c){var d=b.elements;c=c.elements;a=a.elements;b=d[0];var f=d[4],e=d[8],g=d[12],k=d[1],h=d[5],m=d[9],n=d[13],l=d[2],p=d[6],t=d[10],r=d[14],u=d[3],v=d[7],w=d[11],d=d[15],q=c[0],x=c[4],J=c[8],D=c[12],E=c[1],N=c[5],O=c[9],P=c[13],Q=c[2],R=c[6],S=c[10],T=c[14],U=c[3],V=c[7],W=c[11];c=c[15];a[0]=b*q+f*E+e*Q+g*U;a[4]=b*x+f*N+e*R+g*V;a[8]=b*J+f*O+e*S+g*W;a[12]=b*D+f*P+e*T+g*c;a[1]=k*q+h*E+m*Q+n*U;a[5]=k*x+h*N+m*R+n*V;a[9]=k*J+h*O+m*S+n*W;a[13]=k*D+h*P+m*T+n*c;a[2]=l*q+p*E+t*Q+r*U;a[6]=l*x+
p*N+t*R+r*V;a[10]=l*J+p*O+t*S+r*W;a[14]=l*D+p*P+t*T+r*c;a[3]=u*q+v*E+w*Q+d*U;a[7]=u*x+v*N+w*R+d*V;a[11]=u*J+v*O+w*S+d*W;a[15]=u*D+v*P+w*T+d*c};function G(){}
...
function ia(){function a(b,c){if(b instanceof Y){var d=b.element,f=e[b.id];if(void 0===f||""!==f)d.style.WebkitTransform="",d.style.MozTransform="",d.style.Ia="",d.style.transform="",e[b.id]="";d.parentNode!==h&&h.appendChild(d)}d=0;for(f=b.children.length;d<f;d++)a(b.children[d],c)}var b,c=!0,d=0,f="",e={},g=1,k=document.createElement("div");k.style.overflow="hidden";this.a=k;var h=document.createElement("div");k.appendChild(h);this.Na=function(a){c=a};this.sa=function(a,c){b=c;k.style.width=a+"px";
k.style.height=c+"px";h.style.width=a+"px";h.style.height=c+"px"};this.j=function(e,g){var l=.5/Math.tan(H(.5*g.l))*b;d!==l&&(d=l);K(e);void 0===g.parent&&K(g);ca(g.Fa,g.w);l=" scale("+this.Ca(g,k)+") translate("+-g.position.x+"px,"+g.position.y+"px)"+(c?" translate3d(0,0,0)":"");f!==l&&(h.style.WebkitTransform=l,h.style.MozTransform=l,h.style.Ia=l,f=h.style.transform=l);a(e,g)};this.Ca=function(a,b){var c=g;if(0!==b.clientHeight||"undefined"===typeof g)g=c=.5/Math.tan(H(.5*a.l))*b.clientHeight;return c/
a.position.z}};function ja(a,b){function c(a){if(!1!==e.enabled){a.preventDefault();if(x===q.ga){if(!0===e.C)return;p.set(a.clientX,a.clientY);t.G(p,l);0<t.y?e.W():e.X();l.g(p)}else if(x===q.ha){if(!0===e.B)return;k.set(a.clientX,a.clientY);h.G(k,g);e.pan(h.x,h.y);g.g(k)}e.update()}}function d(a){if(!1!==e.enabled){if(2==a.button&&"undefined"!==e.ea&&130>new Date-e.ea.time){a=e.ea.Ja;var b=new CustomEvent("mz_contextmenu");b.clientX=a.clientX;b.clientY=a.clientY;b.target=a.target;a.target.dispatchEvent(b)}document.removeEventListener("mousemove",
c,!1);document.removeEventListener("mouseup",d,!1);e.dispatchEvent(E);x=q.NONE}}function f(a){!0===e.U&&(e.clientX=a.clientX,e.clientY=a.clientY,e.da=!0);if(!1!==e.enabled&&!0!==e.C){var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);0<b?e.X():e.W();e.update();e.dispatchEvent(D);e.dispatchEvent(E)}}this.object=a;this.a=void 0!==b?b:document;this.enabled=!0;this.target=new B;this.C=!1;this.H=1;this.U=!0;this.P=.05;this.K=this.O=1;this.D=2;this.B=!1;this.N=7;this.Ha=!1;this.keys=
{ua:37,wa:38,va:39,ta:40};var e=this,g=new A,k=new A,h=new A,m=new B,n=new B,l=new A,p=new A,t=new A,r=1,u=new B,v=new B,w=new F,q={NONE:-1,ga:1,ha:2,ia:4,ja:5},x=q.NONE;this.Pa=this.target.clone();this.Ka=this.object.position.clone();(new F).Ma(a.Qa,new B(0,1,0)).clone().inverse();var J={type:"change"},D={type:"start"},E={type:"end"};this.ra=function(a){r=.5/Math.tan(H(.5*this.object.l))*this.a.clientHeight/a/this.object.position.z};this.R=function(a){var b=this.object.v.elements;m.set(b[0],b[1],
...
this.a.clientHeight;n.z=Math.max(f/this.O,Math.min(f/this.P,d));e.K=f/n.z;this.target.add(u);c.g(this.target).add(n);r=1;u.set(0,0,0);if(!0===e.da&&!0!==a)e.da=!1,K(this.object),a=e.T(this.object).sub(b),e.R(a.x),e.S(-a.y),e.update();else if(1E-6<v.na(this.object.position)||1E-6<8*(1-w.L(this.object.ca)))this.dispatchEvent(J),v.g(this.object.position),w.g(this.object.ca)};this.reset=function(){x=q.NONE;this.target.g(this.Pa);this.object.position.g(this.Ka);this.update()};this.a.addEventListener("mousedown",
function(a){if(!1!==e.enabled){if(1===a.button){if(!0===e.C)return;a.preventDefault();x=q.ga;l.set(a.clientX,a.clientY)}else if(a.button===e.D){if(!0===e.B)return;a.preventDefault();x=q.ha;g.set(a.clientX,a.clientY);e.ea={time:new Date,Ja:a}}document.addEventListener("mousemove",c,!1);document.addEventListener("mouseup",d,!1);e.dispatchEvent(D)}},!1);this.a.addEventListener("mousewheel",f,!1);this.a.addEventListener("DOMMouseScroll",f,!1);this.a.addEventListener("touchstart",function(a){if(!1!==e.enabled){switch(a.touches.length){case 1:return;
case 2:if(!0===e.C)return;x=q.ia;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;l.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===e.B)return;x=q.ja;g.set(a.touches[0].pageX,a.touches[0].pageY);break;default:x=q.NONE}e.dispatchEvent(D)}},!1);this.a.addEventListener("touchend",function(){!1!==e.enabled&&(e.dispatchEvent(E),x=q.NONE)},!1);this.a.addEventListener("touchmove",function(a){if(!1!==e.enabled)switch(a.preventDefault(),a.stopPropagation(),a.touches.length){case 1:break;
case 2:if(!0===e.C)break;if(x!==q.ia)break;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;p.set(0,Math.sqrt(b*b+a*a));t.G(p,l);0<t.y?e.X():e.W();l.g(p);e.update();break;case 3:if(!0===e.B)break;if(x!==q.ja)break;k.set(a.touches[0].pageX,a.touches[0].pageY);h.G(k,g);e.pan(h.x,h.y);g.g(k);e.update();break;default:x=q.NONE}},!1);window.addEventListener("keydown",function(a){if(!1!==e.enabled&&!0!==e.Ha&&!0!==e.B)switch(a.keyCode){case e.keys.wa:e.pan(0,e.N);e.update();
break;case e.keys.ta:e.pan(0,-e.N);e.update();break;case e.keys.ua:e.pan(e.N,0);e.update();break;case e.keys.va:e.pan(-e.N,0),e.update()}},!1);this.update()}ja.prototype=Object.create(G.prototype);(function(){function a(a,c){c=c||{bubbles:!1,cancelable:!1,detail:void 0};var d=document.createEvent("CustomEvent");d.initCustomEvent(a,c.bubbles,c.cancelable,c.detail);return d}"undefined"===window.CustomEvent&&(a.prototype=window.Event.prototype,window.CustomEvent=a)})();
function Z(a){a=a||{};var b={};b.za=a.containerId||"makeItZoom";b.O=a.maxZoomScale||1;b.P=a.minZoomScale||.1;b.H=a.zoomSpeed||2;b.U=!1!==a.zoomTowardMouse;b.D="undefined"!=typeof a.panButton?a.D:2;b.ma="boolean"===typeof a.disableNativeContextMenu?a.ma:!0;b.Da=!1!==a.hardwareAccelerated;b.fullScreen=!0===a.fullScreen;this.options=b;this.i=document.getElementById(b.za);this.width=this.i.offsetWidth;this.height=this.i.offsetHeight;this.J=new M(70,this.width/this.height,1,1E6);this.u=new X;this.o=new ia;
...
function la(a,b){function c(){d.i.style.width=window.innerWidth;d.i.style.height=window.innerHeight;d.width=d.i.offsetWidth;d.height=d.i.offsetHeight;d.J.I=window.innerWidth/window.innerHeight;ha(d.J);d.o.sa(window.innerWidth,window.innerHeight);d.j()}var d=a;!0===b?(c(),window.addEventListener("resize",c,!1)):window.removeEventListener("resize",c,!1)}y=Z.prototype;y.Aa=function(){return this.i};y.Ea=function(a){var b=this;ma(this,a,function(a){a.Ga=b.pa(a)});ma(this,a,function(a){b.ka.call(b,a,a.Ga)})};
