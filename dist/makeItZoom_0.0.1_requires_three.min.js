...
THREE.CSS2DRenderer=function(a){var d=1,c,f,g,p,x=!0,y=0,z="",A={},b=1,h=document.createElement("div");a&&(h=a);h.style.overflow="hidden";this.domElement=h;var k=document.createElement("div");h.appendChild(k);this.setIsHardwareAccelerated=function(b){x=b};this.setAlignment=function(b){d=1;"CENTER"===b&&(d=0)};this.setSize=function(b,a){c=b;f=a;g=c/2;p=f/2;h.style.width=b+"px";h.style.height=a+"px";k.style.width=b+"px";k.style.height=a+"px"};var r=function(b,a){if(b instanceof THREE.CSS2DObject){var d=
b.element,c=A[b.id];if(void 0===c||""!==c)d.style.WebkitTransform="",d.style.MozTransform="",d.style.oTransform="",d.style.transform="",A[b.id]="";d.parentNode!==k&&k.appendChild(d)}d=0;for(c=b.children.length;d<c;d++)r(b.children[d],a)};this.render=function(b,a){var c=.5/Math.tan(THREE.Math.degToRad(.5*a.fov))*f;y!==c&&(y=c);b.updateMatrixWorld();void 0===a.parent&&a.updateMatrixWorld();a.matrixWorldInverse.getInverse(a.matrixWorld);var c=-a.position.x,q=a.position.y;1===d&&(c+=g,q+=p);c=" scale("+
this.getCurrentZoomScale(a,h)+") translate("+c+"px,"+q+"px)"+(x?" translate3d(0,0,0)":"");z!==c&&(k.style.WebkitTransform=c,k.style.MozTransform=c,k.style.oTransform=c,z=k.style.transform=c);r(b,a)};this.getCurrentZoomScale=function(a,d){var c=b;if(0!==d.clientHeight||"undefined"===typeof b)b=c=.5/Math.tan(THREE.Math.degToRad(.5*a.fov))*d.clientHeight;return c/a.position.z}};THREE.OrbitControls=function(a,d){function c(e){if(!1!==b.enabled){if(1===e.button){if(!0===b.noZoom)return;e.preventDefault();l=m.DOLLY;w.set(e.clientX,e.clientY)}else if(e.button===b.panButton){if(!0===b.noPan)return;e.preventDefault();l=m.PAN;h.set(e.clientX,e.clientY);b.rightClick={time:new Date,originalEvent:e}}document.addEventListener("mousemove",f,!1);document.addEventListener("mouseup",g,!1);b.dispatchEvent(C)}}function f(e){if(!1!==b.enabled){e.preventDefault();if(l===m.DOLLY){if(!0===b.noZoom)return;
...
h);b.pan(r.x,r.y);h.copy(k);b.update();break;default:l=m.NONE}}function A(){!1!==b.enabled&&(b.dispatchEvent(D),l=m.NONE)}this.object=a;this.domElement=void 0!==d?d:document;this._enableInteractions=this.enabled=!0;this.center=this.target=new THREE.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.zoomTowardMouse=!0;this.minZoomScale=.05;this.currentZoomScale=this.maxZoomScale=1;this.bounds=null;this.panButton=2;this.noPan=!1;this.keyPanSpeed=7;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};
...
b||"object"!=typeof b)return null;for(var a=["top","left","bottom","right"],d=[-1,-1,1,1],c=!1,n={},f=0;f<a.length;f++)"[object Number]"===toString.call(b[a[f]])&&(c=!0),n[a[f]]="[object Number]"===toString.call(b[a[f]])?b[a[f]]:Infinity*d[f];return c?n:(THREE.warn("Invalid bounds object specified."),null)};this.setBounds=function(b){this.bounds=b=this.validateBounds(b);null!==b&&this.setMinZoomScale(1)};this.panLeft=function(b){var a=this.object.matrix.elements;v.set(a[0],a[1],a[2]);v.multiplyScalar(-b);
n.add(v)};this.panUp=function(b){var a=this.object.matrix.elements;v.set(a[4],a[5],a[6]);v.multiplyScalar(b);n.add(v)};this.pan=function(a,d){var c=b.domElement===document?b.domElement.body:b.domElement;if(void 0!==b.object.fov){var f=b.object.position.clone().sub(b.target).length(),f=f*Math.tan(b.object.fov/2*Math.PI/180);b.panLeft(2*a*f/c.clientHeight);b.panUp(2*d*f/c.clientHeight)}else void 0!==b.object.top?(b.panLeft(a*(b.object.right-b.object.left)/c.clientWidth),b.panUp(d*(b.object.top-b.object.bottom)/
c.clientHeight)):console.warn("WARNING: ZoomControls.js encountered an unknown camera type - pan disabled.")};this.dollyIn=function(a){void 0===a&&(a=Math.pow(.95,b.zoomSpeed));t/=a};this.dollyOut=function(a){void 0===a&&(a=Math.pow(.95,b.zoomSpeed));t*=a};this.unproject=function(a){var c=new THREE.Vector3;c.set(b.clientX/b.domElement.clientWidth*2-1,2*-(b.clientY/b.domElement.clientHeight)+1,.5);c.unproject(a);var c=c.sub(a.position).normalize(),d=-a.position.z/c.z;return a.position.clone().add(c.multiplyScalar(d))};
...
this.update()};this.enableInteractions=function(b){var a=this.domElement;b=!1!==b;var a={mousedown:{element:a,handler:c},mousewheel:{element:a,handler:p},DOMMouseScroll:{element:a,handler:p},touchstart:{element:a,handler:y},touchend:{element:a,handler:A},touchmove:{element:a,handler:z},keydown:{element:window,handler:x}},d=!1!==b?"addEventListener":"removeEventListener";if(this._enableInteractions!==b||!0!==this.__setupComplete){this.__setupComplete=!0;this._enableInteractions=b;for(var f in a)a.hasOwnProperty(f)&&
a[f].element[d].apply(a[f].element,[f,a[f].handler,!1])}}.bind(this);this.enableInteractions(this._enableInteractions);this.update()};THREE.OrbitControls.prototype=Object.create(THREE.EventDispatcher.prototype);function MakeItZoom(a){this.init(a||{})}
MakeItZoom.prototype.init=function(a){var d={};d.containerId=a.containerId||"makeItZoom";d.maxZoomScale=a.maxZoomScale||1;d.minZoomScale=a.minZoomScale||.1;d.zoomSpeed=a.zoomSpeed||2;d.zoomTowardMouse=!1!==a.zoomTowardMouse;d.panButton="undefined"!=typeof a.panButton?a.panButton:2;d.disableNativeContextMenu="boolean"===typeof a.disableNativeContextMenu?a.disableNativeContextMenu:!0;d.hardwareAccelerated=!1!==a.hardwareAccelerated;d.fullScreen=!0===a.fullScreen;d.bounds=a.bounds||null;d.zeroAtCenter=
!0!==a.zeroAtCenter;d.enableUserInteractions=!1!==a.enableUserInteractions;this.options=d;this.container=document.getElementById(d.containerId);a=this.cacheElements.call(this,this.container);this.width=this.container.offsetWidth;this.height=this.container.offsetHeight;this.camera=new THREE.PerspectiveCamera(70,this.width/this.height,1,1E6);this.scene=new THREE.Scene;this.replaceElements.call(this,a);this.renderer=new THREE.CSS2DRenderer(this.container);this.renderer.setAlignment(this.options.zeroAtCenter?
"CENTER":"TOP_LEFT");this.renderer.setSize(this.width,this.height);this.renderer.setIsHardwareAccelerated(d.hardwareAccelerated);this.renderer.domElement.style.position="absolute";this.render=this.render.bind(this);this.attachControls();this.controls.setScale(1);this.setFullScreen(d.fullScreen);this.controls.update()};MakeItZoom.prototype.setEnableUserInteractions=function(a){this.controls.enableInteractions(a)};
...
MakeItZoom.prototype.getContainer=function(){return this.container};MakeItZoom.prototype.cacheElements=function(a){var d=this,c=[];this.childElementIterator(a,function(a){var f=d.getOffset(a),g=getComputedStyle(a).getPropertyValue("position");if("relative"===g||"static"===g)a.mzOffset=f;c.push(a)});for(var f=0;f<c.length;f++){var g=c[f];a.removeChild(g);g.mzOffset&&(g.style.position="absolute",g.style.top=g.mzOffset.top+"px",g.style.left=g.mzOffset.left+"px")}return c};
MakeItZoom.prototype.replaceElements=function(a){for(var d=0;d<a.length;d++){var c=a[d];this._addZoomable.call(this,c,c.mzOffset)}};MakeItZoom.prototype._addZoomable=function(a){a=new THREE.CSS2DObject(a);this.scene.add(a)};MakeItZoom.prototype.childElementIterator=function(a,d){for(var c=a.children,f=0;f<c.length;f++)d.call(this,c[f])};
...
MakeItZoom.prototype.addZoomable=function(a){this._addZoomable(a);this.render()};MakeItZoom.prototype.removeZoomable=function(a){for(var d=null,c=0;c<this.scene.children.length;c++)this.scene.children[c].element===a&&(d=this.scene.children[c]);null!==d?this.scene.remove(d):console.warn("The specified element could not be removed from the MakeItZoom workspace, because it couldn't be found.");this.render()};
MakeItZoom.prototype.getOffset=function(a){for(var d=0,c=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)d+=a.offsetLeft-a.scrollLeft,c+=a.offsetTop-a.scrollTop,a=a.offsetParent;return{top:c,left:d}};MakeItZoom.prototype.getCurrentScale=function(){return this.controls.currentZoomScale};MakeItZoom.prototype.getCenter=function(){return{x:this.camera.position.x,y:this.camera.position.y}};
MakeItZoom.prototype.zoomTo=function(a,d,c){var f=this.controls.object.position.x,g=this.controls.object.position.y,p=this.controls.currentZoomScale;"number"!==typeof a&&(a=f);"number"!==typeof d&&(d=g);"number"!==typeof c&&(c=p);this.controls.panLeft(f-a);this.controls.panUp(-d-g);this.controls.setScale(c);this.controls.update(!0)};MakeItZoom.prototype.getScene=function(){return this.scene};MakeItZoom.prototype.getCamera=function(){return this.camera};MakeItZoom.prototype.getRenderer=function(){return this.renderer};
THREE.EventDispatcher.prototype.apply(MakeItZoom.prototype);window.MakeItZoom=MakeItZoom;MakeItZoom.prototype.addZoomable=MakeItZoom.prototype.addZoomable;MakeItZoom.prototype.removeZoomable=MakeItZoom.prototype.removeZoomable;MakeItZoom.prototype.zoomTo=MakeItZoom.prototype.zoomTo;MakeItZoom.prototype.getCurrentScale=MakeItZoom.prototype.getCurrentScale;MakeItZoom.prototype.getCenter=MakeItZoom.prototype.getCenter;MakeItZoom.prototype.getOffset=MakeItZoom.prototype.getOffset;
MakeItZoom.prototype.getContainer=MakeItZoom.prototype.getContainer;MakeItZoom.prototype.setEnableUserInteractions=MakeItZoom.prototype.setEnableUserInteractions;
